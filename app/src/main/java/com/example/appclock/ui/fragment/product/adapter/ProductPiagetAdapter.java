...
public class ProductPiagetAdapter extends RecyclerView.Adapter<ProductPiagetAdapter.ViewHolder> {
    private List<ProductModel> listProductPiaget;
    private Context context;
    private OnActionCallbackHomeAdapterToHomeFragment callBack;

    public ProductPiagetAdapter(List<ProductModel> listProductPiaget, Context context) {
        this.listProductPiaget = listProductPiaget;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductModel productModel = listProductPiaget.get(position);
